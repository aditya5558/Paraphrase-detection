...
def log(message,file_path=os.path.join('glove_gru_att','log.txt')):
...
if __name__ == '__main__':
	...
	with tf.Session() as sess:
		...
		trained_model = os.path.join('glove_gru_att', 'model.ckpt')
		trained_model_restore = os.path.join('glove_gru_att', 'model.ckpt.meta')
		...
		if os.path.isfile(trained_model_restore):
			...
			train_writer = tf.summary.FileWriter("glove_gru_att/",sess.graph)
